import sys, pathlib, pyglet.font as pygletFont
...
def crash_window():
    ...
    text: dict[str, str]= {}
    with open("assets/data/text.csv", "r") as file:
        for row in file.read().split("\n"):
            v = row.split(":")
            text[v[0]] = v[1].replace("\\n", "\n").replace("\\t", "\t")
        file.close()
    pygletFont.add_file("assets/fonts/pixel.ttf")
    #endregion
    ...
    error__png = tk.PhotoImage(file="assets/images/error.png").zoom(2)
